        ...
        if ev.type == pygame.QUIT:
            ...
            if ev.button == 1:
                if start_button.collidepoint(ev.pos):
                    click_button(screen,start_button)
                    diff_select(screen)
                    break
                elif inst_button.collidepoint(ev.pos):
                    click_button(screen,inst_button)
                    inst_page(screen)
                    break
        pygame.display.flip()
    pygame.quit()
        ...
        if ev.type == pygame.QUIT:
            ...
            if ev.button == 1:
                if menu_button.collidepoint(ev.pos):
                    click_button(screen,menu_button)
                    main_menu()
                    break
        ...
        if ev.type == pygame.QUIT:
            ...
            if ev.button == 1:
                if menu_button.collidepoint(ev.pos):
                    ...
                    diff = 2
                if start:
                    click_button(screen,buttons[diff])
                    main_control(screen,diff)
                    break
        pygame.display.flip()
    pygame.quit()
...
def print_labled_buttons(screen,buttons,texts,colors,offset):
    if type(colors) != type([]):
        color = colors
...
def game(screen,question):
    ...
    while True:
        ...
        print_labled_buttons(screen,ans_buttons,ans_texts,ans_colors,[10,10])
...
def click_button(screen,button):
